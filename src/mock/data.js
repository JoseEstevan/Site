...
export const aboutData = {
  img: 'Profile.jpg',
  paragraphOne: 'I work as a Data Analyst, focused on analysis and decision making, transforming business needs into indicators and data into strategic information.',
  paragraphTwo: 'I am always looking for new skills that allow me to try new solutions and technologies, with versatility and thirst for learning.',
  paragraphThree: '',
  resume: 'https://drive.google.com/file/d/1v2Bl46V1gnWZGgcGhW75yxOOS8OVNkgh/view?usp=sharing', // if no resume, the button will not show up
};
